...
public class ManagerCreditAccountController implements Initializable {
    ...
    /**
     * This Manager function can make payments to loan accounts or deposits to checking and savings accounts when the
     * credit button is clicked in the Manager credit menu
